...
<select name="class" id="modal-class" class="form-select" required>
...
<select name="section" id="modal-section" class="form-select" required>
...
<div class="mb-3">
    ...
    <select class="form-select" id="relation" name="relation" style="width:100%;" required>
        <option selected disabled value="">--select--</option>
