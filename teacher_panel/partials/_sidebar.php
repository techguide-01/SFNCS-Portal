<div class="sidebar">
    <a href="dashboard.php" class="logo">
        ...
        <img src="../images/1.png">
          <div class=""><span class="text-warning">SFNCS</span><span class="darkTextColor">Portal</span></div>
    </a>
    ...
    <ul class="side-menu main-side-board">
        ...
        <li><a href="timetable.php"><i class='bx bx-table'></i>Schedule</a></li>
        <li><a href="syllabus.php"><i class='bx bxs-file-blank'></i>Modules</a></li>
        <li><a href="notes.php"><i class='bx bx-note'></i>Notes</a></li>
        <li><a href="marks.php"><i class='bx bx-paste'></i>Grading System</a></li>
