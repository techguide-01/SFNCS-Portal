...
<head>
    ...
    <title>ERP - Student List</title>
</head>
<body>
    <div class="nav-bar">
       <nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="../images/1.png" style="height: 50px;"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="teacher-list.php">Total Teachers</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="student-list.php">Total Students</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex align-items-center">
            <div id="oranbyte-google-translator" class="me-2"
              ...
              ></div>
        <input class="form-control me-2" type="search" placeholder="Search" id="search-student" aria-label="Search">
    ...
    <div class="selection p-3">
        <select class="form-select w-25" id="form-select">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">VIEW ACCOUNT</th> </tr>
  </thead>
  <tbody id="tb">
    </tbody>
</table>
