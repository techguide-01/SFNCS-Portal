...
<head>
  <meta charset="UTF-8">
  <title>San Felipe Neri Catholic School</title>
  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">San Felipe Neri Catholic School<br></span>
          <span class="text-2">I am an Apostle and so are you!</span>
        </div>
      </div>
